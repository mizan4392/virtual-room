...
export type CreateServerMutation = {
  ...
  createServer: {
    ...
    name: string;
    imageUrl: string;
    members?: Array<{ __typename?: "Member"; id: string } | null> | null;
  };
};
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateProfileDto" },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateServerDto" },
            },
          },
        },
        {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetServers" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GetServersQuery, GetServersQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetServer" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetServerQuery, GetServerQueryVariables>;
